<nav class="bg-gradient-to-r from-yellow-100 to-yellow-300 shadow-md sticky top-0" x-data="{ profileOpen: false, menuOpen:false }">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex">
                        <a href="/services"
                            class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-600 hover:bg-gray-100 focus:outline-none focus:text-gray-700 focus:bg-gray-100 transition duration-150 ease-in-out">{{ __('Services') }}</a>
                        <a href="/about"
                            class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-600 hover:bg-gray-100 focus:outline-none focus:text-gray-700 focus:bg-gray-100 transition duration-150 ease-in-out">{{ __('About') }}</a>
                        <a href="contact"
                            class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-600 hover:bg-gray-100 focus:outline-none focus:text-gray-700 focus:bg-gray-100 transition duration-150 ease-in-out">{{ __('Contact') }}</a>
                    </div>
                </div>
            </div>
    ...
    <div x-cloak :class="{ 'block': menuOpen, 'hidden': !menuOpen }" @click.away="menuOpen = false" class="sm:hidden">
        <div class="px-2 pt-2 pb-3">
            ...
            <a href="/services"
                class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">{{ __('Services') }}</a>
            <a href="about"
                class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">{{ __('About') }}</a>
            <a href="contact"
                class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">{{ __('Contact') }}</a>
        </div>
    </div>
</nav>