...
<h2 class="font-bold text-xl mb-6 text-gray-800 border-b pb-2">Update User Details</h2>
...
<div class="flex">
    ...
    <div class="mb-2 w-1/2 mr-2">
        ...
        <input class="text-right mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-1 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-yellow-300" wire:model="title" type="text">
    </div>
</div>
<div class="mb-2 w-1/2 mr-2">
...
<div class="mt-6 text-right">
    <button type="button" class="bg-yellow-300 hover:bg-gray-700 text-white font-semibold py-2 px-4 border border-gray-700 rounded shadow-sm" wire:click="update()">
        Update User
    </button>   
</div>
</div>
